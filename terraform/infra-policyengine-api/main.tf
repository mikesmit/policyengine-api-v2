...
locals {
  metadata = "{\"uri\":\"${module.cloud_run_simulation_api.uri}\",\"revision\":\"${module.cloud_run_simulation_api.latest_ready_revision}\",\"models\":{\"us\":\"${var.policyengine-us-package-version}\",\"uk\":\"${var.policyengine-uk-package-version}\"}}"
}
